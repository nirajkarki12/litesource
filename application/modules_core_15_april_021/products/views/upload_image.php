...
<div class="grid_10" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<h3 class="title_black"><?php echo $this->lang->line('upload_image'); ?></h3>
		...
		<div class="content toggle">
			...
			<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>" enctype="multipart/form-data">
				...
				<input type="submit" id="btn_submit" name="btn_upload" value="<?php echo $this->lang->line('upload_image'); ?>" />
