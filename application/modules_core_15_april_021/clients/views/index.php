...
<div class="grid_12" id="content_wrapper">
    ...
    <div class="section_wrapper">
        ...
        <h3 class="title_black">
            ...
            <form method="post" action="<?= site_url('clients/contacts/download_all_contacts');?>" style="display: inline;">
                <input type="submit" style="float: right; margin-right: 10px;" value="CSV »">
            </form>
