...
<script>
    ...
    var columns2 = [
        ...
        {id: "name", name: "Product Name", field: "n", sortField: "name", width: parseFloat((typeof $.cookie('inventory_grid_name') != 'undefined') ? $.cookie('inventory_grid_name') : '432'), sortable: true, fieldLink: "id", editor: TextCellEditor,
    ...
    $(document).ready(function () {
        ...
        $.post("<?php echo site_url('inventory/get_link_group_type'); ?>", {
        }, function (data) {
