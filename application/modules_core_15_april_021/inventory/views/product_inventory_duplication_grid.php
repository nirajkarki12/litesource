...
<script type="text/javascript">
    ...
    var columns = [
//        {id: "inventory_name", name: "Inventory Name", field: "inv", sortField: "inventory_name", width: parseFloat((typeof $.cookie('inv_prod_inventory_name') != 'undefined') ? $.cookie('inv_prod_inventory_name') : '390'), sortable: true, fieldLink: "ii",
//            linkUrl: "<?php echo site_url('inventory/form/inventory_id/'); ?>", asyncPostRender: asyncRenderInventoryLink},
//        {id: "qty", name: "QTY", field: "qty", sortField: "qty", width: parseFloat((typeof $.cookie('inv_prod_qty') != 'undefined') ? $.cookie('inv_prod_qty') : '160'), sortable: true, editor: QuantityCellEditor},
        {id: "product_name", name: "Product Name", field: "pn", sortField: "product_name", width: parseFloat((typeof $.cookie('inv_prod_product_name') != 'undefined') ? $.cookie('inv_prod_product_name') : '390'), sortable: true, fieldLink: "pi",
    ...
    function update_inventory(item, field)
    {
        ...
        $.post("<?php echo site_url('inventory/update_inv_rel'); ?>", {
...
//        }
    ...
    function applyFilter() {
        ...
        if (!all_data_loaded) {
            ...
            $.post("<?php echo site_url('inventory/get_product_for_duplicate'); ?>", {
                limit: 10000,
                offset: 0
