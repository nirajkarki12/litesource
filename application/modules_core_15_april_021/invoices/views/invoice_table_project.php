		...
		<?php foreach ($invoices as $invoice) { ?>
			...
			<tr>
                            ...
                            <!--<td class="first status_3">Closed</td>-->
                                <?php // }else{ ?>
                            <td class="first status_<?=$invoice->invoice_status_id?>"> <?=$invoice->invoice_status?> </td>
                                <?php // } ?>
				...
				<td>
                                    <?php if ($invoice->invoice_quote_id) { ?>
                                        <a href="<?php echo site_url('/quotes/edit/invoice_id') .'/'. $invoice->invoice_quote_id; ?>"><?php echo $invoice->invoice_quote_number; ?></a>
                                    <?php } ?> 			
				</td>
