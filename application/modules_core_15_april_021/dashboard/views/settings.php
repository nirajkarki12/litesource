...
<dl>
	<dt><?php echo $this->lang->line('dashboard_show_open_quotes'); ?></dt>
	<dd><input type="checkbox" name="dashboard_show_open_quotes" value="TRUE" <?php if($this->mdl_mcb_data->setting('dashboard_show_open_quotes') == "TRUE"){ ?>checked="checked"<?php } ?> /></dd>
</dl>