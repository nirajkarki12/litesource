...
class Upload_Inventory extends Admin_Controller
{
    ...
    function do_export()
    {
        ...
        $sort_by = $this->input->post('sort_by') != '' ? $this->input->post('sort_by') : 'inventory_id';
        ...
        $this->load->model('mdl_inventory_import');
        $inventories = $this->mdl_inventory_import->export_updated_inventories($lastchanged, $sort_by, $sort_order);
        redirect($this->session->userdata('last_index'));
    }
