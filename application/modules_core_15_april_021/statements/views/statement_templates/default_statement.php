...
<table class="info">
    ...
    <tr>
        ...
        <td class="data">
            ...
            <?php   foreach ($delivery_docket as $value) { $sum+= ($value->price_with_tax - $value->paid_amount); }
...
<table class="items">
    ...
    <tr class="item">
        <td>
            <?php $docket_date = date('d/m/Y',$dd->invoice_date); echo $docket_date;  ?>
        </td>
...
//            }
            ...
            $current_date = time();
            $due_date = date("Y-m-t",($dd->docket_due_date));
            ...
            if ((round(($due_date- $current_date) / (60 * 60 * 24))) >= 1) {
                ...
                echo '<p style="color:red;">' . round(($current_date - $due_date) / (60 * 60 * 24)) . ' days</p>';
            } else {
                echo '<p style="color:red;">Last day</p>';
            }
        ...
        <td align="right">
            <?php echo display_currency($dd->price_with_tax - $dd->paid_amount ); ?>
        </td>
    </tr>
    <?php } ?>
