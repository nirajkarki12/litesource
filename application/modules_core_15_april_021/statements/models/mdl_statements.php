...
class Mdl_Statements extends MY_Model {
    ...
    function get_delivery_for_Pdf($client_id) {
        ...
        $qry = 'SELECT i.client_id, i.project_id, i.invoice_number, i.invoice_id, i.invoice_client_order_number, '
                . 'd.docket_id, d.docket_number, d.docket_due_date, d.invoice_date, d.docket_date_entered, d.invoice_sent, d.docket_delivery_status, d.price_with_tax, '
                . 'p.project_name, p.project_id, '
                . '(SELECT ROUND((SUM(mcb_delivery_docket_payment.amount_entered)),2) FROM mcb_delivery_docket_payment WHERE docket_id=d.docket_id) AS paid_amount '
