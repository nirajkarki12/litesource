	...
	<div class="section_wrapper">
		...
		<div class="content toggle no_padding">
			...
			<table>
				...
				<tr>
					<td class="first"><?php echo $account->client_center_id; ?></td>
					<td><?php echo $account->client_name; ?></td>
					<td><?php echo $account->username; ?></td>
					<td><?php echo format_date($account->last_login); ?></td>
					<td><?php echo anchor('client_center/admin/form/client_center_id/' . $account->client_center_id, $this->lang->line('edit'), array('class'=>'edit')); ?></td>
					<td class="last"><?php echo anchor('client_center/admin/delete/client_center_id/' . $account->client_center_id, $this->lang->line('delete'), array('class'=>'delete', 'onclick'=>"javascript:if(!confirm('" . $this->lang->line('confirm_delete') . "')) return false")); ?></td>
				</tr>
				<?php } ?>
			</table>
