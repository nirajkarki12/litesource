<dl>
	...
	<dd>
		...
		<div class="tax_rate" style="margin-left: 200px;">
			...
			<?php if ($invoice_tax_rate->tax_rate_option == 1) { echo $this->lang->line('item_tax_option_1'); }
			elseif ($invoice_tax_rate->tax_rate_option == 2) { echo $this->lang->line('item_tax_option_2'); } ?>)<br />
		</div>
		<?php } ?>
	</dd>
</dl>
