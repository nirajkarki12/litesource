...
class Client_Center extends Client_Center_Controller {
	...
	function generate_pdf() {
		...
		$this->lib_output->pdf($invoice_id, $this->mdl_mcb_data->setting('default_invoice_template'));
	...
	function generate_html() {
		...
		$this->lib_output->html($invoice_id, $this->mdl_mcb_data->setting('default_invoice_template'));
