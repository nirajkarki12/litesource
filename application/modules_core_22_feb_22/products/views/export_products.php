...
<div class="grid_7" id="content_wrapper">
    ...
    <div class="section_wrapper">
        ...
        <h3 class="title_black"><?php echo $this->lang->line('export_product_data'); ?></h3>
        ...
        <div class="content toggle">
            <form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>" >
                ...
                <input type="submit" id="btn_submit" name="btn_export_products" value="<?php echo $this->lang->line('export_product_data'); ?>" />
