...
<dl>
	<dt><?php echo $this->lang->line('disable_delete_links'); ?></dt>
	<dd><input type="checkbox" name="disable_delete_links" value="1" <?php if ($this->mdl_mcb_data->setting('disable_delete_links')) { ?>checked="checked"<?php } ?>/></dd>
</dl>
