			...
			<table>
				...
				<tr>
					...
					<td class="last">
						...
						<?php /*<a href="<?php echo site_url('users/delete/user_id/' . $user->user_id); ?>" title="<?php echo $this->lang->line('delete'); ?>" onclick="javascript:if(!confirm('<?php echo $this->lang->line('confirm_delete'); ?>')) return false">
