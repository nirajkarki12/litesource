...
class Mdl_Invoice_Search extends MY_Model {
	...
	public function validate() {
		...
		$this->form_validation->set_rules('contact_name', $this->lang->line('contact_name'));
		$this->form_validation->set_rules('client_name', $this->lang->line('client_name'));
		$this->form_validation->set_rules('project_name', $this->lang->line('project_name'));
		$this->form_validation->set_rules('product_name', $this->lang->line('product_name'));
		$this->form_validation->set_rules('product_description', $this->lang->line('product_description'));
