...
var js_docket_delivery_status = '<?=$docket->docket_delivery_status?>';
var js_main_invoice_status = '<?=$main_invoice_status?>';

console.log(js_docket_delivery_status);
console.log(js_main_invoice_status);
	...
	QuantityCellEditor = function(args)
	{
		...
		this.init = function() {
                    ...
                    ///// if deleverd
                    if( js_docket_delivery_status == '1' ){
                        $input = $("<INPUT type=text class='editor-text' disabled/>");
                    }else if(js_main_invoice_status != '1'){
                        $input = $("<INPUT type=text class='editor-text' disabled/>");
                    }
