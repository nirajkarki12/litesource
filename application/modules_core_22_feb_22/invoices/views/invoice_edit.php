...
?>
<style type="text/css">
    button#btn_quote_to_orders_invoice[disabled]{
            ...
            <div class="title_black">
                <div class="title_btns">
                    ...
                    <?php } else { ?>
                        ...
                        <button type="submit"  id="btn_quote_to_orders_invoice" name="btn_quote_to_orders_invoice" style="float: right; margin-top: 14px; margin-right: 10px;">
                            <?php echo $this->lang->line('quote_to_orders_invoice'); ?>
                        </button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function showPopup(whichpopup) {
            ...
            $('.popup' + whichpopup).find('input[type="submit"]').attr('disabled', false);
        }
        function closePopup() {
        ...
        $('#btn_quote_to_orders_invoice').on('click', function (e) {
            ...
            let processing_text = "<img src='<?php echo base_url();?>assets/style/img/loading.gif' style='vertical-align:sub'> Processing please wait...";
            let default_text = $('#btn_quote_to_orders_invoice').text();
            $('#btn_quote_to_orders_invoice').attr('disabled', true).html(processing_text);
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#btn_quote_to_orders_invoice').html(default_text);
...
<div class="overlay-content popup1 pop_edit_invc_design">
    <form method="post" action="<?=site_url('invoices/quote_to_orders_invoice/invoice_id/' . $invoice->invoice_id)?>" class="popup-form">
