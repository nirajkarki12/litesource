...
<div class="grid_10" id="content_wrapper">
	...
	<?php if ($this->mdl_mcb_data->setting('dashboard_show_open_quotes') == "TRUE") { ?>

	<div class="section_wrapper">

		<h3 class="title_black"><?php echo $this->lang->line('open_quotes'); ?></h3>

		<div class="content toggle no_padding">

			<?php $this->load->view('invoices/quote_table', array('quotes'=>$open_quotes, 'is_quote'=>TRUE)); ?>
...
<?php //$this->load->view('dashboard/sidebar', array('show_quicklinks'=>TRUE)); ?>
