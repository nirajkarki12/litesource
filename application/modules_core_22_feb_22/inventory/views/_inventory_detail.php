...
<?php echo form_open_multipart($this->uri->uri_string(), array('id' => 'inventory_form')); ?>
...
<div class="section_wrapper">
    ...
    <div class="content toggle">
        ...
        <dl>
            ...
            <dd>
                <select onChange="show(this.options[this.selectedIndex].value)" id="inventory_type" <?php if (uri_assoc('inventory_id') > 0) {
                    echo 'disabled';
                }else{ echo 'name="inventory_type"';} ?>>
        ...
        <div id="group">
            ...
            <div class="content toggle">
                ...
                <dl>
                    <dt><label>Quantity : </label></dt>
                    <dd>
                        <input type="text" class="qty_inventory_item" id="inventory_qty" value="1" style="width: 259px;" />
    ...
    <?php }else { ?>
        <div id="part">
            ...
            <?php if($inventory_items && $inventory_items !== 'false'){?>
                <h3 class="title_black"><?php echo $this->lang->line('related_inventory_to_group_product'); ?></h3>
                <div class="content toggle">
                    <?php $this->load->view('inventory_grid_inverse_relation'); ?>
                </div>
            <?php }?>               
        </div>
    <?php } ?>
    ...
    <button type="reset" id="btn_cancel" name="btn_cancel" value="Clear">Clear</button>
</div>
</form>