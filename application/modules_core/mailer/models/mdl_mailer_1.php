...
class Mdl_Mailer extends MY_Model {
    ...
    public function email_docket_invoice($invoice, $invoice_template, $update_due_date, $from_email, $from_name, $to, $subject, $email_body, $email_cc = NULL, $email_bcc = NULL, $reply_to = NULL,$docket) {
        $data = array();
