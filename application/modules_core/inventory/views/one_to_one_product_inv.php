        ...
        <body>
            <div class="morefilters" style="margin-top: 20px; margin-left: 20px;">
                <div class="one">
                    ...
                    <a href="<?php echo site_url() ?>/inventory/one_to_one_product_inv"><strong style="text-decoration: underline;">One to One</strong></a> | 
            ...
            <div class="row" style="margin-top: 30px;">
                <div class="link_inventory_grid">
                    <?php $this->load->view('one_inventory_grid'); ?>
                </div>
