...
<script type="text/javascript">
    ...
    var columns = [
        ...
        {id: "name", name: "Inventory Name", field: "name", sortField: "name", width: parseFloat((typeof $.cookie('inventory_grid_name') != 'undefined') ? $.cookie('inventory_grid_name') : '280'), sortable: true, fieldLink: "id",
...
//    {id:"supplier_description", name:"Supplier Description", field:"supplier_description",sortField:"",width:150,sortable:false,editor: TextCellEditor},
        {id: "qty", name: "Product Relation Qty", field: "qty", sortField: "", width: parseFloat((typeof $.cookie('inventory_grid_qty') != 'undefined') ? $.cookie('inventory_grid_qty') : '150'), sortable: true, editor: QuantityCellEditor},
    ];
    ...
    $(document).ready(function () {
        ...
        $.post("<?php echo site_url('inventory/get_inventory_list'); ?>", {
        }, function (data) {
            if (data == 'session_expired') {
                window.location.reload();
            }
