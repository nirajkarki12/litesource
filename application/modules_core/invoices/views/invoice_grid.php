...
?>
    ...
    var columns = [
        ...
        {id: "docket_count", name: "Dockets", field: "docket_count", width: 95, cssClass: "docket-count text-center",asyncPostRender: asyncRenderDocketCount},
        <?php endif; ?>
    ...
    $(document).ready(function () {
        ...
        if (grid === undefined) {
            ...
            if (global_is_quote == 1) {
                ...
                columns.splice(8, 1); //Remove Project Specifer on invoices
            }
        ...
        <?php if (uri_seg(1) == 'invoices'): ?>
                    var url = "<?php echo site_url('invoices/get_invoices_JSON_withDocket'); ?>";
<?php else: ?>
